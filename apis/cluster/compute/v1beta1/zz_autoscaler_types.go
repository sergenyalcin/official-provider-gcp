...
type AutoscalerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/cluster/compute/v1beta1.InstanceGroupManager
...
type MetricInitParameters struct {
	...
	// instead.
	SingleInstanceAssignment *float64 `json:"singleInstanceAssignment,omitempty" tf:"single_instance_assignment,omitempty"`
