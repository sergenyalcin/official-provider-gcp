...
type RegionDiskAsyncPrimaryDiskInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/cluster/compute/v1beta1.RegionDisk
...
type RegionDiskInitParameters struct {
	...
	// valid values:
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/cluster/compute/v1beta1.Snapshot
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
